...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div id="contenido">
    <a class="btn btn-primary" href="nuevoU.php">Nuevo Usuario</a>
        <hr>
    ...
    <?php 
            ...
            ?>  
                <tr>
                    <td><?php echo $usuarios[$x]["id"]; ?></td>
                    <td><?php echo $usuarios[$x]["username"]; ?></td>
                    <td><?php echo $usuarios[$x]["passwordd"]; ?></td>

                    <td>
                      <img class="icon-edit" width=20px src="edit.png" usid="<?php echo $usuarios[$x]["id"] ?>">
                    </td>
                    <td>
                      <img class="icon-borrar" width=20px src="delete.png" usid="<?php echo $usuarios[$x]["id"] ?>">
                    </td>
                </tr>
            <?php
                }
            ...
            $(".icon-edit").click(function(){
                ...
                window.location = "editarU.php?id=" + id;
            ...
            $(".icon-borrar").click(function(){
                ...
                if(confirm("Estas seguro qué deseas eliminar al usuario?")){ 
                    window.location = "eliminarU.php?id=" + idx; 
                }
            });
        </script>    
          </div>
